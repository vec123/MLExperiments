...
# ------------- Data with a Specific Covariance Matrix
...
# -------------- Data Distributed Around a Parabola with Covariance Noise
...
# -------------- Data Distributed Around a Circle with Covariance Noise
...
np.save('data/data_parabola_sine_variance.npy', data)
...
plt.axis('equal')
plt.tight_layout()
plt.savefig('specific_covariance.png')
plt.close()
...
plt.axis('equal')
plt.tight_layout()
plt.savefig('uniform_line (regular distribution).png')
plt.close()
...
plt.axis('equal')
plt.tight_layout()
plt.savefig('transformed_uniform_line (regular distribution).png')
plt.close()
...
plt.tight_layout()
plt.savefig('continous_varying_variance_sine.png')
plt.close()
...
plt.axis('equal')
plt.tight_layout()
plt.savefig('circle_mean_sine_variance.png')
plt.close()
...
plt.axis('equal')
plt.tight_layout()
plt.savefig('parabola_mean_sine_variance.png')
plt.close()
